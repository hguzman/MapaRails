class ModelosController < ApplicationController
  ...
  private
    ...
    def modelo_params
      params.require(:modelo).permit(:Accident, :informe, :transito, :transit_id, :gravedad, :latitud, :longitud, :direccion, :localidad, :fecha_ocurrencia_at, :fecha_levantamiento_at, :clase_accidente, :choque_con, :objeto_fijo, :area, :sector, :zona, :diseno, :clima)
    end
end
